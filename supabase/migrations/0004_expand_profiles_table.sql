...
create index if not exists idx_profiles_username_tmp on public.profiles(username);
create index if not exists idx_profiles_visibility on public.profiles(account_visibility);
